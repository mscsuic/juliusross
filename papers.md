...
- a generalized Brunn–Minkowski theorem,  
- log‑concavity of $\mathrm{vol}(A_t)$.
...
- new log‑convexity statements for characteristic classes of nef bundles,  
- another proof that Schur polynomials are Lorentzian.
...
- proof that the weak Hele–Shaw flow on $\mathbb{P}^1$ is strictly increasing,  
- examples where boundary data produce Hele–Shaw flows with corner singularities and corresponding HMAE solutions that fail to be $C^1$.
...
- the Kontsevich moduli of stable maps from curves.
...
- geodesic rays strictly in class $C^{1,1}$ (not $C^2$),  
- smooth geodesic rays recovering classical constructions of Donaldson,  
- families of smooth geodesic rays on the hyperbolic unit disc using results of Hedenmalm–Shimorin.
...
- multi‑Gieseker‑stable sheaves have projective moduli spaces,  
- different stability choices yield moduli related by Thaddeus flips.

Consequences include:

- any two Gieseker moduli spaces (in any dimension) are connected by Thaddeus flips,  
- for smooth threefolds, moduli spaces of sheaves stable with respect to irrational polarizations (Kähler classes) are actually projective.
...
- we exhibit examples where the HMAE solution is far from smooth,  
- we disprove an established result of Chen–Tian regarding regularity of weak geodesics.
...
- an associated flow of sets from any submanifold,  
- in the special case of a point in $\mathbb{P}^1$, the Hele–Shaw flow,  
- explicit volume formulas reminiscent of classical Riemannian tube formulas (Gray).
...
- short-time existence results for the flow starting from an initial domain,  
- short-time existence when starting from the *empty* domain.
...
- embeddings into *weighted* projective space,  
- allowing orbifold structure in codimension one,  
- interpretation of orbifold Kähler metrics with cone angle $2\pi/m$ along divisors.
...
- slope stability for canonical polarizations of manifolds with $c_1 < 0$,  
- slope stability for general polarizations on Calabi–Yau manifolds,  
- examples of unstable projective bundles, blowups, and rational manifolds.
